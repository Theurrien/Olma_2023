...
Auch bei diesem Modell wurden die T-Size Werte berechnet. Der korrigierte T-Size Wert für den CFI beträgt `r round(equivalence_testing(554, 25, T_ml=793.014, df=268, T_mli=6278.572, alpha=0.05)[2,2],3)` und der RMSA `r round(equivalence_testing(554, 25, T_ml=793.014, df=268, T_mli=6278.572, alpha=0.05)[2,3],3)`. Verglichen mit den ebenfalls korrgierten T-Size korrigierten Werten (vgl. @tbl-cutoff_aqui_str) kann der CFI als mediocre und der RMSA als fair eingeschätzt werden.
...
SEM_plot <-lavaanPlot2(model_fit2, 
            include = "covs",
