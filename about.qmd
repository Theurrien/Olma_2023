...
semPaths(model_fit1,
         ...
         edge.label.cex = 1.5, 
         sizeLat = 10,
         nodeLabels = c("","","","","","","","","","","","","","","","","","","","","","CANX", "PRA", "IMO", "KBE", "KBU"))
```
...
Das Item IMO_1 kann als ein äusserst starker Indikator für die beiden Skalen KBE und KBU angesehen werden. Da diese Skalen völlig unterschiedliche Konstrukte messen, sticht diese Beziehung in besonderer Weise hervor.
